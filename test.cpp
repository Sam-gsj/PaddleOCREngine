...
int main(){
    ...
    params.text_detection_model_dir = "/home/badguys/PaddleOCR/deploy/cpp_infer/models/PP-OCRv5_mobile_det_infer"; // 文本检测模型路径
    params.text_recognition_model_dir = "/home/badguys/PaddleOCR/deploy/cpp_infer/models/PP-OCRv5_mobile_rec_infer"; // 文本识别模型路径
    ...
    params.thread_num = 2;   //***************************多线程推理

    auto infer = PaddleOCR(params);
    auto input = cv::imread("/home/badguys/PaddleOCR/deploy/cpp_infer/general_ocr_002.png");
    std::vector<cv::Mat> inputs = {input,input,input,input};
    ...
    // params_doc.doc_orientation_classify_model_dir = "/home/badguys/PaddleOCR/deploy/cpp_infer/models/PP-LCNet_x1_0_doc_ori_infer"; // 文档方向分类模型路径。
    // params_doc.doc_unwarping_model_dir = "/home/badguys/PaddleOCR/deploy/cpp_infer/models/UVDoc_infer"; // 文本图像矫正模型路径。
    // auto infer_doc = DocPreprocessor(params_doc);
    // auto input_doc = cv::imread("/home/badguys/PaddleOCR/deploy/cpp_infer/general_ocr_002.png");
